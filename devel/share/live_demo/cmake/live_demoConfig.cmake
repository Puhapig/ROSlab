...
if(NOT "/home/harvey/workspace/lab01/devel/include " STREQUAL " ")
  set(live_demo_INCLUDE_DIRS "")
  set(_include_dirs "/home/harvey/workspace/lab01/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'live_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harvey/workspace/lab01/src/live_demo/${idir}'.  Ask the maintainer 'harvey <harvey@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/harvey/workspace/lab01/devel/lib;/home/harvey/workspace/lab01/devel/lib;/opt/ros/indigo/lib)
